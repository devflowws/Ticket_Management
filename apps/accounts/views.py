...
class LoginView(APIView):
    ...
    def post(self, request):
        ...
        # Si l'utilisateur est admin et company_id est fourni, on peut l'ignorer ou le stocker
        ...
        if user.company:
            ...
            # Pour admin, on peut quand même ajouter l'info entreprise si fournie
            try:
    ...
    """Connexion utilisateur avec support company_id pour mobile"""
    permission_classes = [AllowAny]
    ...
    def post(self, request):
        ...
        # Vérification de l'entreprise (sauf pour admin)
        if user.role != 'admin':
            if not company_id:
                return Response(
                    {'error': 'Veuillez fournir votre ID entreprise'},
